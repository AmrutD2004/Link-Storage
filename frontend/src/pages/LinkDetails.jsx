                    ...
                    <div className='px-7 pt-7 pb-5 border-b border-[#F3F4F6]'>
                        <div className='flex items-start justify-between gap-4'>
                            ...
                            <div className='flex items-start gap-4 flex-1 min-w-0'>
                                {/* Favicon placeholder */}
                                <div className='w-11 h-11 rounded-xl bg-[#EBF5FF] border border-[#BFDBFE] flex items-center justify-center flex-shrink-0 text-lg'>
                                    🔗
                                </div>
                            ...
                            <div className='flex items-center gap-2 shrink-0 relative'>
                                <Link
                                    ...
                                    rel='noopener noreferrer'
                                    to={linkDetails.actual_link}
                                    className='flex items-center gap-1.5 text-xs font-medium text-[#3B82A6] hover:text-[#0B3A66] bg-[#EBF5FF] hover:bg-[#D6EDF9] border border-[#BFDBFE] px-3 py-1.5 rounded-lg transition-all duration-150'
                                >
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className='flex items-center gap-1.5 text-xs font-medium text-red-500 hover:text-red-600 bg-red-50 hover:bg-red-100 border border-red-200 px-3 py-1.5 rounded-lg transition-all duration-150 disabled:opacity-50'
                                >
                                    <Trash2 size={11} />
                                    {loading ? 'Deleting...' : 'Delete'}
                                </button>
                                <div className='group'>
                                    <button onClick={() => setOpen(true)} className='p-1 hover:bg-gray-200 rounded-lg cursor-pointer text-[#0B3A66] font-medium '><Share2 size={18} /></button>
                                    <span className='absolute text-xs px-3 py-1 tracking-tight leading-tight bg-neutral-800 text-white rounded-lg shadow -right-3 -top-6.5 opacity-0 group-hover:opacity-100 transition-all duration-200'>Share</span>
                                </div>
