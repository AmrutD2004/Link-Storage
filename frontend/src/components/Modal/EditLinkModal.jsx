import { Check, Link, Loader2, Plus, X, XIcon } from 'lucide-react'
import React, { useContext, useState } from 'react'
import { CategoryContext } from '../../context/CategoryContext'
import { createLink, editLink, fetchURLTitle, getlinkDetails } from '../../api/endpoint'
import toast from 'react-hot-toast'

const EditLinkModal = ({ onClose, link, linkId }) => {

    const [tags, setTags] = useState(link.link_tags || [])
    ...
    const [url, setUrl] = useState(link.actual_link)
    ...
    const handleSubmit = async(e)=>{
        ...
        try{
            ...
            const data = await editLink(linkId, payload)
            if(data.success){
