...
import { EllipsisVertical, Pencil, Search, SquareArrowOutUpRight, Trash2 } from 'lucide-react'
          ...
          >
            ...
            <div className='flex items-start justify-between px-5 pt-5 pb-3 gap-3'>
              <div className='flex flex-col gap-1.5 flex-1 min-w-0'>
                ...
                {/* Title */}
                <h2 className='text-sm font-semibold text-neutral-800 leading-snug line-clamp-2 group-hover:text-[#0B3A66] transition-colors duration-200'>
                  {link.link_title}
                </h2>
